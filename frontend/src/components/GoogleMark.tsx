/**
 * Фирменная марка Google в её собственных цветах.
 *
 * Не иконка из общего набора: правила использования бренда требуют
 * оригинальные цвета и пропорции, а одноцветный глиф их нарушает.
 */
